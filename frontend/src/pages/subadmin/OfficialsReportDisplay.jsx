...
function LoadingSpinner() {
  ...
  return (
    <div style={{
      ...
      height: "100vh", background: "#f8f9fa", color: "#0a6847",
                ...
                <div className="report-body__grid">
                    ...
                    <section className="report-images">
                        <div className="image-display">
                            ...
                            <img src={reportImg} alt="Original report" className="image-display__img" />
                        </div>
                        <div className="image-display">
                            <h2 className="image-display__caption">AI Processed Image</h2>
                            <img src={reportYoloImg} alt="YOLO processed report" className="image-display__img" />
                        </div>
                    </section>
                    ...
                    <section className="report-details">
                        <div className="info-box">
                            ...
                            <dl>
                                <dt>Status</dt>
                                <dd><span className={`status-badge status--${status}`}>{status}</span></dd>
                        ...
                        <div className="info-box">
                            ...
                            <dl>
                                <dt>Name</dt>
                                <dd>{reportOwner.fname} {reportOwner.lname}</dd>
